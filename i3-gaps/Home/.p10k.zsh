# Generated by Powerlevel10k configuration wizard on 2020-09-13 at 18:07 CEST.
...
# sharp tails, 2 lines, dotted, left frame, darkest-ornaments, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=213
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=213
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=103
